...
bfs_ky_df <- bfs_ky_df %>% 
  ...
  mutate(existing_estabs = lag(estab),
         new_as_pct_of_existing = round(new_estab / existing_estabs * 100,1),
         new_yoy_pct = round(new_estab / lag(new_estab) * 100,1))
